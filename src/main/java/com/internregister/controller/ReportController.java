...
public class ReportController {
    ...
    private ByteArrayOutputStream generatePdfReport(String internName, String department, String field, String fromDate,
        ...
        try {
            ...
            // Logo header
            try {
                java.io.InputStream logoStream = getClass().getClassLoader().getResourceAsStream("univen-logo-2.png");
                if (logoStream != null) {
                ...
                System.err.println("Could not load Univen logo for PDF: " + logoEx.getMessage());
            }

            // Title
            Paragraph title = new Paragraph("UNIVERSITY OF VENDA\nINTERN ATTENDANCE REPORT")
    ...
    private ByteArrayOutputStream generateExcelReport(String internName, String department, String field,
        ...
        try {
            ...
            String[] headers = { "Intern Name", "Email", "Department", "Present", "Absent", "On Leave",
                    "Attendance %" };
            ...
            for (Intern intern : interns) {
                ...
                row.createCell(2)
                        .setCellValue(intern.getDepartment() != null ? intern.getDepartment().getName() : "N/A");
    ...
    private List<Intern> getFilteredInterns(String internName, String department, String field) {
        ...
        // Check if current user is a supervisor - if so, only show their assigned
        // interns
